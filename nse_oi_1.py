...
# @Last Modified time: 2019-02-19 16:25:11
...
def generate_option_data(symbolname, e_date):
    ...
    return get_option_data(symbolname, e_date)[0]
...
def update_expiry_value(exp_options):
    ...
    if n_clicks is not None:
        ...
        generate_option_data(symbolname, e_date)
    # return {'symbol': , 'expiry_date': ''}


# only for label text
output_elements = ['pcr_id', 'maxpain_id', 'tabs-content-example']
...
for output_element in output_elements:
    ...
    app.callback(Output(output_element, 'children'), [Input('tabs-example', 'value'),
