...
# @Last Modified time: 2019-02-18 11:51:39
...
def get_option_data(symbolname, e_date):
    ...
    print("Scrp_option_data", Scrp_option_data[1:])
...
def create_callback(output_id):
    def callback(e_date, symbolname, selected_tab, n_clicks):
        ...
        if output_id == 'tabs-content-example':
            ...
            return '''
                {}
                '''.format(Scrp_data_upd=get_option_data(symbolname, e_date)[1])
        elif output_id == 'pcr_id':
            return '''
                {}
                '''.format(Scrp_data_upd=get_option_data(symbolname, e_date)[2])
        elif output_id == 'maxpain_id':
            return '''
                {}
                '''.format(Scrp_data_upd=get_option_data(symbolname, e_date)[3])
